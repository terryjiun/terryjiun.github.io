...
將「在 &&#35;91;開始&&#35;93; 或工作列上的捷徑清單中顯示最近開啟的項目」調整成「關閉」，再恢復成「開啟」，<br>
...
這和螢幕解析度沒有太大的關係，因為筆者有將解析度調整成最大的 1920&&#35;42;1080，結果也是一樣。<br>
...
<br>
二、複製這一行字串（路徑及機碼）：<br>
　　<span style="color: blue">HKEY&&#35;95;CURRENT&&#35;95;USER&&#35;92;SOFTWARE&&#35;92;Microsoft&&#35;92;Windows&&#35;92;CurrentVersion&&#35;92;Explorer&&#35;92;Advanced</span><br>
　　把它貼到「登錄編輯程式」的最上列，也就是「網址列」，然後按下 <span style="color: blue">Enter</span> 鍵。<br>
　　（若未顯示網址列，可點選功能表「檢視→網址列」，將它顯示出來）<br>
<br>
三、手動建立「<b>JumpListItems&&#35;95;Maximum</b>」這個 DWORD 名稱，如下圖所示。<br>
　　(1) 先複製【<span style="color: blue">JumpListItems&&#35;95;Maximum</span>】這組字串，<br>
...
四、點選「<span style="color: blue">JumpListItems&&#35;95;Maximum</span>」，對其<span style="color: blue">按右鍵</span>，選「<span style="color: blue">修改</span>」，之後會出現下圖。<br>
